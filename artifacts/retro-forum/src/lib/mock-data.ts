    ...
    forums: [
      {
        id: "f5",
        name: "Scripting Help",
        description: "Post your Lua scripting questions here. Experienced scripters, help out the newbies!",
        threads: 889,
        posts: 9234,
        lastPost: {
          date: "Today @ 1:05 AM",
          author: "LuaWiz123",
          threadId: "t11",
          threadTitle: "how do i make a door that opens"
        }
      },
      {
        id: "f6",
        name: "Place Showcase",
        description: "Show off your places! Include screenshots. Rate and review other peoples places too.",
        threads: 430,
        posts: 3102,
        lastPost: {
          date: "15 Jun 2007 9:44 PM",
          author: "PlaceMaker99",
          threadId: "t12",
          threadTitle: "MY SWORD FIGHTING PLACE IS OUT NOW"
        }
      }
    ]
  },
    ...
    forums: [
      {
        id: "f7",
        name: "Introductions",
        description: "New to 2006blox? Introduce yourself to the community here!",
        threads: 1200,
        posts: 8900,
        lastPost: {
          date: "Today @ 12:52 AM",
          author: "newkid2007",
          threadId: "t13",
          threadTitle: "hi im new here"
        }
      },
      {
        id: "f8",
        name: "Clans & Groups",
        description: "Recruit members for your clan, announce wars, and organize group events.",
        threads: 298,
        posts: 2410,
        lastPost: {
          date: "16 Jun 2007 8:00 PM",
          author: "ClanLeader_X",
          threadId: "t14",
          threadTitle: "BLOX ARMY is recruiting!! [200+ members]"
        }
      }
    ]
  }
